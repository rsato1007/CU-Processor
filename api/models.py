...
class Member(models.Model):
    ...
    ssn = models.IntergerField(validators=[MinValueValidator(100000000), MaxValueValidator(999999999)])
    ...
    home_number = models.IntergerField(null = True)
    mobile_number = models.IntergerField(null = True)
    work_number = models.IntergerField(null = True)